...
let PartnerBookmarks = {
  ...
  _tempFix: function() {
    ...
    let item = {
      ...
      title: '\u5929\u732b11.11',
      uri: 'http://s.click.taobao.com/t?e=m%3D2%26s%3DMWPQxnRbJJ8cQipKwQzePCperVdZeJviK7Vc7tFgwiFRAdhuF14FMdGpqsK2uqZnMMgx22UI05ZoVxuUFnM6iMUjUj9sJ%2FOjxctsWvavBZ6hMMc65kB68aUuZxIcp9pfUIgVEmFmgnaR4ypTBJBwtELRPOwzLySnsd%2B%2Ff4Fhw9YqBpZyPCnXrnPkMgwOU3W9Xu2rmNBz2FrM5UxHFoTvZhmm9iOlgkMj5EkZZaIbX8XLP4XO97Tuio%2BgRw6KoLAkxiXvDf8DaRs%3D'
    };
    ...
    if (PlacesUtils.keywords) {
      return PlacesUtils.keywords.fetch(keyword).then(function(keywordObj) {
        ...
        let index = refIndex === Infinity ? item.indexNoRef : refIndex;
